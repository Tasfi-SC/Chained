...
@export var start_time: float = 2.5  # Where the music should start/loop back to
@export var end_time: float = 15.0    # Where the music should "hit the wall" and restart
