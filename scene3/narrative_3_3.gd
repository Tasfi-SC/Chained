...
const dialog_lines : Array[String] = [
	"PIX: Call it tragedy or call it misery",
	"PIX: but even by hell standards...",
	"PIX: Your fate is something [shake]PITIFUL[/shake]",
	"MC NAME: Who are YOU?",
	"PIX: In some distant version of things..",
	"PIX: you might have [color=red]fared better...[/color]"
]
...
func _input(event):
	if event.is_action_pressed("next_line"):
		if dialog_index < len(dialog_lines) -1:
			...
			get_tree().change_scene_to_file("res://narrative/scenes/S3-S4TRANSITION.tscn")
