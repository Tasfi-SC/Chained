...
const dialog_lines : Array[String] = [
	"PIX:You keep unlocking doors, little prince.",
	"PIX: Have you asked yourself who built them"
]
...
func _input(event):
	if event.is_action_pressed("next_line"):
		if dialog_index < len(dialog_lines) -1:
			...
			get_tree().change_scene_to_file("res://scene3/Scene3_3.tscn")
